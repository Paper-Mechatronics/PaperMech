			...
			<div class="option-container mb_tab">
				...
				<div class="inside">					
					...
					<div class="option-design">
						...
						<div class="input"><input type="checkbox" id="external_css" name="external_css" value="1" <?php checked($external_css,1) ?>> <?php _e("Warning: This will remove all styling of the buttons!","maxbuttons"); ?> </div>
						<div class="clear"></div>
					</div>
